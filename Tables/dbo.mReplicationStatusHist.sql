...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[mReplicationStatusHist] (
...
GO
CREATE CLUSTERED INDEX [CIX_mReplicationStatusHist]
	ON [dbo].[mReplicationStatusHist] ([monitor_time], [publisher], [publisher_db])
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[mReplicationStatusHist] SET (LOCK_ESCALATION = TABLE)
GO
