...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[mBlockingHist] (
...
GO
CREATE CLUSTERED INDEX [CIX_mBlockingHist]
	ON [dbo].[mBlockingHist] ([monitor_time], [server_name])
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[mBlockingHist] SET (LOCK_ESCALATION = TABLE)
GO
